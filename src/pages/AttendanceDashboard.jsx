...
const AttendanceDashboard = ({defaultSport}) => {
      ...
      <div className="p-6">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <Button onClick={() => { loadSessions(); loadStudents(); }} variant="outline">
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div>
          <h1 className="text-3xl font-bold text-foreground">Gym & Swimming Attendance</h1>
          <p className="text-muted-foreground mt-1">Manage attendance for {defaultSport || "Gym"} students</p>
        </div>
            ...
            <div className="text-center p-4 bg-muted rounded-lg">
              <div className="flex items-center justify-center gap-2">
                ...
                <span className="text-lg font-semibold text-foreground">
                  Showing attendance for: <span className="text-primary">{date}</span>
                </span>
              </div>
            </div>
          </CardContent>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-4 text-sm text-muted-foreground">
                              <span>URN: {st.urn}</span>
                              <span>CRN: {st.crn}</span>
                              <span>Branch: {st.branch}</span>
                              <span>Year: {st.year}</span>
                            </div>
                            <div className="flex items-center gap-4 text-sm text-muted-foreground mt-1">
                              <span>Sport: {st.sport}</span>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div className="flex gap-2">
                            <Button
                              onClick={() => { setEditStudent(st); setForm(st); setShowForm(true); }}
                              variant="outline"
                              size="sm"
                              className="flex items-center gap-2"
                            >
        ...
        <ModalContent>
          <div className="mb-4 p-3 bg-muted rounded-lg">
            <p className="text-sm text-muted-foreground">
              Session: <strong className="text-foreground">{sessions.find(s => s._id === selectedSession)?.session}</strong>
            </p>
          </div>
