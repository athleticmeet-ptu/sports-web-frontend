        ...
        <Card> 
          ...
          <CardContent> 
            <div className="flex flex-col sm:flex-row gap-4"> 
              <Button onClick={exportExcel} disabled={loading} className="flex items-center gap-2 flex-1" variant="outline" > 
                {loading ? ( 
                  <> 
              ...
              <Button onClick={exportWord} disabled={loading} className="flex items-center gap-2 flex-1" variant="outline" > 
                {loading ? ( 
                  <> 
                    <RefreshCw className="w-4 h-4 animate-spin" /> Exporting... 
                  </> 
